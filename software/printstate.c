...
#ifndef WORDTOU64
/* Convert internal word representation to uint64_t (identity by default). */
#define WORDTOU64(x) ((uint64_t)(x))
#endif

#ifndef U64LE
/* Convert host uint64 to little-endian display value (identity by default). */
#define U64LE(x) (x)
#endif
